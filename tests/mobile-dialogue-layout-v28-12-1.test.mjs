...
test("la r̩ponse mobile ne recouvre plus la note de navigabilit̩", () => {
...
test("le nouveau style est charg̩ sans reprendre l'ancien cache", () => {
  assert.match(index, /page-B7dK8B51\.css\?v=28\.12\.3/);
  assert.match(index, /standalone-v28-9-4\.js\?v=28\.14\.0/);
});
